...
if __name__ == '__main__':
    ...
    optimizer = torch.optim.Adam(list(generator.parameters()) + list(discriminator.parameters()), lr=learning_rate)
    # Train the model
    loss_gs = []
    loss_ds = []
    ...
    # a = random.randint(0, 50); graph_as_picture(x[a], x_noisy[a], x_hat[a])

    # Save the model checkpoints
    torch.save(generator.state_dict(), 'generator_m2.ckpt')
    torch.save(discriminator.state_dict(), 'discriminator_m2.ckpt')
